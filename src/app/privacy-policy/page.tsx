    ...
    <LandingShell>
      <div className="mx-auto w-full max-w-3xl py-12 md:py-20 text-muted-foreground">
        ...
        <div className="space-y-6 leading-7">
          ...
          <h2 className="text-xl font-semibold text-foreground mt-10">1. Introduction</h2>
          ...
          <h2 className="text-xl font-semibold text-foreground mt-10">2. The Data We Collect</h2>
          ...
          <h2 className="text-xl font-semibold text-foreground mt-10">3. How We Use Your Data</h2>
          ...
          <h2 className="text-xl font-semibold text-foreground mt-10">4. Data Security</h2>
          <p>We have put in place appropriate security measures to prevent your personal data from being accidentally lost, used or accessed in an unauthorized way, altered or disclosed. In addition, we limit access to your personal data to those employees, agents, contractors and other third parties who have a business need to know.</p>
          
          <h2 className="text-xl font-semibold text-foreground mt-10">5. Contact Us</h2>
