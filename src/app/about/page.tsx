  ...
  return (
    <LandingShell>
      <div className="mx-auto w-full max-w-3xl py-12 md:py-20 text-slate-300">
        <h1 className="mb-8 text-4xl font-bold tracking-tight text-white">About ToolHive</h1>
        <div className="space-y-6 leading-7">
          ...
          <h2 className="text-xl font-semibold text-white mt-10">Our Mission</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-white mt-10">Privacy First</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-white mt-10">Get in Touch</h2>
          <p>
