    ...
    <LandingShell>
      <div className="mx-auto w-full max-w-3xl py-12 md:py-20 text-slate-300">
        ...
        <div className="space-y-6 leading-7">
          ...
          <h2 className="text-xl font-semibold text-white mt-10">3. User Conduct</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-10">4. Modifications to Service</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-10">5. Governing Law</h2>
