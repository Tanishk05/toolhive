  ...
  return (
    <LandingShell>
      <div className="mx-auto w-full max-w-3xl py-12 md:py-20 text-slate-300">
        <h1 className="mb-8 text-4xl font-bold tracking-tight text-white">Disclaimer</h1>
        <div className="space-y-6 leading-7">
          <p>Last updated: {new Date().toLocaleDateString()}</p>

          <h2 className="text-xl font-semibold text-white mt-10">1. Website Information</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-white mt-10">2. External Links Disclaimer</h2>
          <p>
            The Site may contain (or you may be sent through the Site) links to other websites or content belonging to or originating from third parties or links to websites and features in banners or other advertising. Such external links are not investigated, monitored, or checked for accuracy, adequacy, validity, reliability, availability or completeness by us.
          </p>

          <h2 className="text-xl font-semibold text-white mt-10">3. Tools and Utilities</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-white mt-10">4. Financial / Legal Advice Disclaimer</h2>
          <p>
