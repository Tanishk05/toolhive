...
const dialogContentVariants = cva(
  "fixed left-1/2 top-1/2 z-50 grid w-[min(92vw,36rem)] -translate-x-1/2 -translate-y-1/2 gap-4 rounded-[var(--radius)] border border-border bg-popover p-6 text-popover-foreground shadow-[0_30px_90px_rgba(0,0,0,0.55)] outline-none"
);
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title ref={ref} className={cn("text-2xl font-semibold tracking-tight text-foreground", className)} {...props} />
));
